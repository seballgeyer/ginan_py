...
class Clocks:
    ...
    """
    def __init__(self, data : MeasurementArray = None, satlist: list = [], series: str=None, series_base: str = None) -> None:
        self.data = data
    ...
    def process(self) -> None:
        ...
        for sat in self.satlist:
            ...
            if ref is not None and est is not None:
                ...
                result.append(
                    Measurements(epoch=common_time, data=data, identifier={'sat':sat, 'series':self.series}))
