...
class testSinexSatMetadata(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        input_data = StringIO(testdataset)
    ...
    def sinexDateConvertor(self) -> None:
        from ginan.io.sinex import snx_date_np
        input_str = "2010:058:25610"
        out = snx_date_np(input_str)
        self.assertEqual(out, np.datetime64('2010-02-27T07:06:50'))

    def sinexDataConvertor(self) -> None:
        from ginan.io.sinex import snx_np_date
